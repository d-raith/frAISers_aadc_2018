#!/bin/sh
echo "adtf build_user.sh is active" > /home/aadc/AADC/src/aadcUser/NN/PredictionServer/build_active.txt
...
rm /home/aadc/AADC/src/aadcUser/NN/PredictionServer/build_active.txt