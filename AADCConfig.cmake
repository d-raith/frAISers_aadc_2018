...
#------- OpenCV 3.4.2 ------------------------------------------
#-------------------------------------------------------
find_package(OpenCV 3.4.1 REQUIRED  PATHS
		"/opt/opencv/3.4.1"
		"C:/SDK/opencv/3.4.1")
...
if(WIN32)
	find_package(Thrift REQUIRED NO_DEFAULT_PATH
		PATHS "C:/SDK/thrift/0.11.0")
	if(Thrift_FOUND)
		set(AADC_THRIFT_FOUND TRUE)
		message(STATUS "Found Thrift: ${THRIFT_INCLUDE_DIR}")
	endif(Thrift_FOUND)
else(WIN32)
	set(THRIFT_INCLUDE_DIR "/usr/local/include/thrift")
	set(THRIFT_LIBRARY_DIR "/opt/thrift/0.11.0/lib")
	message(STATUS "Found Thrift.")
	message(STATUS "Thrift Include dir is: ${THRIFT_INCLUDE_DIR}")
	message(STATUS "Thrift Lib dir is: ${THRIFT_LIBRARY_DIR}")
	set(AADC_THRIFT_FOUND TRUE)
	FIND_LIBRARY(THRIFT_LINK_LIBS NAMES
				thrift
				thriftc
				thriftz
				PATHS
...
#-------------------------------------------------------
unset(AIRSIM_ROOT)
find_path(AIRSIM_ROOT NAMES AirSim.sln PATHS "/opt/AirSim2/")
message(STATUS "Found AirSim. AirSim root dir is: ${AIRSIM_ROOT}")
